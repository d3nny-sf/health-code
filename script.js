...
const RECIPES = [
    // RICHARD
    {
        ...
        photoUrl: "assets/characters/richard.png",
        v1: {
            protein: "~33g",
  ...
  prep: "15 minutes", cook: "35-40 minutes", servings: 6 }`
    ...
    // ERLICH
    {
        ...
        photoUrl: "assets/characters/erlich.png",
        v1: {
            protein: "~33g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "20 minutes", cook: "40-45 minutes", servings: 8 }`
    ...
    // GILFOYLE
    {
        ...
        photoUrl: "assets/characters/gilfoyle.png",
        v1: {
            protein: "~33g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "15 minutes", cook: "35 minutes", servings: "2-3" }`
    ...
    // DINESH
    {
        ...
        photoUrl: "assets/characters/dinesh.png",
        v1: {
            protein: "~25g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "10 minutes", chill: "1 hour", yield: "4 cups" }`
    ...
    // JARED
    {
        ...
        photoUrl: "assets/characters/jared.png",
        v1: {
            protein: "~28g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "10 minutes", cook: "10 minutes", servings: 3 }`
    ...
    // BIG HEAD
    {
        ...
        quote: "// I don't really know how I got here, but the smoothie is good.",
        photoUrl: "assets/characters/bighead.png",
        v1: {
            protein: "~20g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "10 minutes", freeze: "3-4 hours", servings: "2-4" }`
    ...
    // GAVIN
    {
        ...
        quote: "// I don't want to be the best smoothie. I want to be the ONLY smoothie.",
        photoUrl: "assets/characters/gavin.png",
        v1: {
            protein: "~22g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "20 minutes", cook: "40-45 minutes", servings: 8 }`
    ...
    // RUSS
    {
        ...
        photoUrl: "assets/characters/russ.png",
        v1: {
            protein: "~15g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "10 minutes", freeze: "3-4 hours", servings: "2-4" }`
    ...
    // MONICA
    {
        ...
        photoUrl: "assets/characters/monica.png",
        v1: {
            protein: "~22g",
            time: "Pre-Workout · 1 PM",
  ...
  prep: "5 minutes", servings: 4 }`
    ...
    // JIAN-YANG
    {
        ...
        quote: "// Not hotdog. Smoothie.",
        photoUrl: "assets/characters/jianyang.png",
        v1: {
            protein: "~25g",
            time: "Pre-Workout · 1 PM",
